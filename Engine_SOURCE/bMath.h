...
namespace b::math
{
	...
	struct Rectangle
	{
		...
		// explicit : 사용자가 원하지 않은 형변환이 일어나지 않도록 제한하는 키워드
	...
	struct Vector2 : public XMFLOAT2
	{
		...
		// t에 따라 v1과 v2를 선형 보간, 오브젝트를 부드럽게 이동하거나 회전할 시에 사용
		...
		// Lerp와 유사함, 시간이 흐를수록 속도가 높아지고, 일정 위치에 다다르면 속도가 점점 줄어듦
