...
namespace b
{
	...
	void BossLobbyScene::Initialize()
	{
		...
		bgColorMr->SetMesh(Resources::Find<Mesh>(L"DefaultMesh"));
		...
		// cloud
		{
			...
			smallCloudsMr->SetMesh(Resources::Find<Mesh>(L"DefaultMesh"));
			...
			bigCloudMr->SetMesh(Resources::Find<Mesh>(L"DefaultMesh"));
		...
		bgTreeMr->SetMesh(Resources::Find<Mesh>(L"DefaultMesh"));
