...
namespace b
{
	...
	void LobbyScene::Initialize()
	{
		// background
		{
			...
			tree01Mr->SetMesh(Resources::Find<Mesh>(L"RectMesh"));
			...
			// pillar
			{
				...
				pillar01Mr->SetMesh(Resources::Find<Mesh>(L"RectMesh"));
				...
				pillar02Mr->SetMesh(Resources::Find<Mesh>(L"RectMesh"));
				...
				pillar03Mr->SetMesh(Resources::Find<Mesh>(L"RectMesh"));
				...
				pillar04Mr->SetMesh(Resources::Find<Mesh>(L"RectMesh"));
				...
				pillar05Mr->SetMesh(Resources::Find<Mesh>(L"RectMesh"));
			...
			//rDoor->AddComponent<Collider2D>();
			{
				...
				foreTree01Mr->SetMesh(Resources::Find<Mesh>(L"RectMesh"));
				...
				fore_Bush04Mr->SetMesh(Resources::Find<Mesh>(L"RectMesh"));
				...
				fore_Bush02Mr->SetMesh(Resources::Find<Mesh>(L"RectMesh"));
				...
				fore_Bush01Mr->SetMesh(Resources::Find<Mesh>(L"RectMesh"));
		...
		tileMr->SetMesh(Resources::Find<Mesh>(L"RectMesh"));
